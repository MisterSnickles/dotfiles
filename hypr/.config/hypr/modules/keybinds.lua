...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("/home/snickles/.config/waybar/scripts/launch.sh"), {description = "reload waybar and swaync for live update"})
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("/home/snickles/.config/waybar/scripts/open-close-waybar.sh"),{description = "toggle waybar"})
